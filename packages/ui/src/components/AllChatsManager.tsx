        ...
        <div className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
             <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 border border-border bg-card rounded-lg text-sm font-medium text-muted-foreground hover:bg-muted transition-colors"
        ...
        <DialogContent className="sm:max-w-[460px] sm:rounded-[16px] gap-0 p-6">
          ...
          <DialogFooter className="mt-10 flex sm:justify-end gap-3">
            <button
              ...
              className="px-8 py-2.5 rounded-[12px] border border-border text-sm font-bold text-muted-foreground hover:bg-muted transition-colors min-w-[100px]"
            >
              {t('common.cancel')}
            </button>
            <button
