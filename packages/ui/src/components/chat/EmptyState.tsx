      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {suggestions.map((s, i) => (
          <button
            ...
            className="flex items-center gap-3 p-4 rounded-[16px] bg-muted/40 border border-border/60 hover:border-primary/30 hover:shadow-[0_4px_16px_rgba(236,91,20,0.08)] transition-all text-left group"
          >
