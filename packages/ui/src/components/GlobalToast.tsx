      ...
      <AnimatePresence>
        {toasts.map(t => (
          <motion.div
            ...
            className="bg-card border border-border shadow-[0_4px_24px_rgba(0,0,0,0.06)] rounded-full pl-3 pr-4 py-2.5 flex items-center gap-3 pointer-events-auto min-w-[240px]"
          >
            ...
            <button 
              ...
              className="p-1 rounded-full hover:bg-muted text-muted-foreground/80 transition-colors"
            >
