...
export function getFriendlyToolName(
  ...
  const toolNameMap: Record<string, string> = {
    ...
    'local_git': t('chat.tool.local_git', 'Local Git'),
    'local_bash': t('chat.tool.local_bash', 'Local Bash'),
    'local_file_read': t('chat.tool.read_file', 'Read File'),
    'local_file_edit': t('chat.tool.file_edit', 'Edit File'),
    'local_plan': t('chat.tool.local_plan', 'Plan Mode'),
